...
const timelineEvents = [
  ...
  {
    year: 2019,
    title: "First Festival Appearance",
    description: "Performed at Soundwave Festival and released debut album.",
    details:
      "My performance at Soundwave Festival marked a turning point, reaching an audience of over 5,000 people. Released debut album 'Dimensions' which received critical acclaim from music publications.",
  },
  {
    year: 2020,
    title: "Digital Transformation",
    description: "Pivoted to virtual performances and online collaborations.",
    details:
      "Adapted to global changes by hosting a series of virtual concerts that reached audiences worldwide. Collaborated with artists across 5 countries on the 'Connected' project.",
  },
  {
    year: 2021,
  ...
  },
  {
    ...
    description: "Completed first international tour across 10 countries.",
    details:
      "The 'Echoes World Tour' included 25 shows across Europe, Asia, and North America, performing to a combined audience of over 50,000 fans. Released the live album 'Echoes: Live' capturing the tour highlights.",
  },
  {
    year: 2023,
